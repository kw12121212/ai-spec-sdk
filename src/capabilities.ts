...
export const CALLABLE_METHODS: readonly string[] = [
  "bridge.capabilities",
  ...
  "session.setProvider",
  "token.getUsage",
  "token.getSessionSummary",
  "token.getMessageUsage",
  "token.getProviderUsage",
  "token.clearAll",
  "token.registerCounter",
  "token.listCounters",
  "quota.set",
  "quota.get",
  "quota.list",
