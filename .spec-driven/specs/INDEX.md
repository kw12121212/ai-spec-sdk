...
- `bridge/json-rpc-stdio.md` — JSON-RPC 2.0 stdio transport, capability discovery (including session.history advertisement), streaming notifications, session event schema, agent message sub-type contract, session listing, and Go CLI integration example
