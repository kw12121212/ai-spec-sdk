...
- `rate-limiting` - Declared: complete - per-key token bucket rate limiting for HTTP transport
- `custom-tool-registration` - Declared: complete - workspace-scoped shell-command custom tools
